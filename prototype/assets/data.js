 ...
 * 📐 设计原型数据基准：含 12 个 API 与手写 SVG 图表范式。
 * app/ 已扩展（DEFAULT_APIS=29、Recharts、双主题），详见 prototype/index.html 顶部说明。
...
const i18n = {
  zh: {
    title: 'LLM API Sentinel v2.10.34 | 全球LLM API实时监控',
    statsOnline: '在线服务',
    statsDegraded: '降级服务',
    statsOffline: '离线服务',
    statsLatency: '平均延迟',
  ...
  en: {
    title: 'LLM API Sentinel v2.10.34 | Global AI API Monitoring',
