    ...
    <footer id="main-footer" className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 pt-8 border-t border-border/10">
      <div className="space-y-3">
        ...
        <p className="text-[11px] leading-relaxed opacity-60">
          Real-time monitoring across multiple regions with global API status tracking.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="text-[11px] leading-relaxed opacity-60">
          Secure monitoring with Firebase integration and real-time data synchronization.
        </p>
      </div>
    </footer>
  );
