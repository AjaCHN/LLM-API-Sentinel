    ...
    <footer id="main-footer" className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 pt-8 border-t border-border/10">
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-[10px] font-bold uppercase tracking-widest">{t('footer.coverage')}</h4>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-[10px] font-bold uppercase tracking-widest">{t('footer.ui')}</h4>
        </div>
        <p className="text-[11px] leading-relaxed opacity-60">
          {t('footer.uiDesc')}
        </p>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-[10px] font-bold uppercase tracking-widest">{t('footer.integrity')}</h4>
        </div>
        <p className="text-[11px] leading-relaxed opacity-60">
